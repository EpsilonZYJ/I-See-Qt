...
- 🎬 **AI 视频生成**：支持文本到视频和图片到视频生成任务，可自定义参数
- 🖼️ **图生视频**：从静态图片生成视频，支持可选的起始帧和结束帧
...
3. **生成视频**
   ...
   **文生视频模式：**
   - 选择"文生视频 (Text-to-Video)"模式
   - 在文本框中输入提示词
   - 点击"生成视频"按钮
   - 观看实时进度更新
   
   **图生视频模式：**
   - 选择"图生视频 (Image-to-Video)"模式
   - 点击"选择首帧图片"选择起始图片
   - （可选）点击"选择尾帧图片"选择结束帧
   - 输入可选的提示词以获得更好效果
   - 点击"生成视频"按钮
...
**图生视频：**
1. 从模式选择器选择"图生视频"模式
2. 点击"选择首帧图片"按钮选择起始图片
   - 支持的格式：JPEG、PNG、WebP、BMP、TIFF、GIF
   - 图片会显示预览
3. （可选）点击"选择尾帧图片"按钮选择结束帧
   - 起始和结束帧将引导视频生成
4. （可选）输入文本提示词以增强生成效果
   - 虽然是可选的，但建议添加提示词
5. 点击"生成视频（图生视频）"按钮
